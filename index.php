      ...
      <div id="swupMain" class="mil-main-transition">
          ...
          <div class="mi-invert-fix">
            ...
            <div class="container">
              <div class="mil-banner-content mil-up">
                <h1 class="mil-muted mil-mb-60 newtextHeading">
                  Designing <span class="mil-thin">a Better</span><br />
                  World <span class="mil-thin">Today</span>
                </h1>
                <div class="row">
                ...
                <a href="service.php" class="mil-button mil-arrow-place mil-btn-space">
                  <span>What we do</span>
                </a>

                <a href="portfolio.php" class="mil-link mil-muted mil-arrow-place">
              ...
              <div class="col-lg-6 col-md-6  col-xl-5">
                <div class="mil-mb-90">
                  <h2 class="mil-up mil-mb-60">
                    Discover <br />Our <span class="mil-thin">Studio</span>
                  </h2>
          ...
          <div class="mi-invert-fix">
            ...
            <div class="container mil-p-120-0">
              <div class="mil-mb-120">
                <div class="row">
                  <div class="col-lg-10">
                    <span class="mil-suptitle mil-light-soft mil-suptitle-right mil-up">Professionals focused on helping your brand<br />
                ...
                <div class="mil-complex-text justify-content-center mil-up mil-mb-15">
                  ...
                  <h2 class="mil-h1 mil-muted mil-center">
                    Unique <span class="mil-thin">Ideas</span>
                  </h2>
                </div>
                <div class="mil-complex-text justify-content-center mil-up">
                  <h2 class="mil-h1 mil-muted mil-center">
                    For Your <span class="mil-thin">Business.</span>
                  </h2>
                  <a href="service.php" class="mil-services-button mil-button mil-arrow-place"><span>What we do</span></a>
                </div>
              </div>
          ...
          <div class="container mil-p-120-30">
            <div class="row justify-content-between align-items-center">
              <div class="col-lg-5 col-xl-4">
                <div class="mil-mb-90">
                  <h2 class="mil-up mil-mb-60 newtextHeading">Meet <br />Our Team</h2>
                  <p class="mil-up mil-mb-30">
                  ...
                  <div class="mil-up">
                    <a href="about.php" class="mil-button mil-arrow-place mil-mb-60"><span>Read more</span></a>
                  </div>
                  ...
                  <div class="row mil-mb-60">
                    <div class="col-sm-6">
                        ...
                        <div class="mil-description">
                          <div class="mil-secrc-text">
                            <h5 class="mil-muted mil-mb-5">
                              <a href="index.php">Anna Oldman</a>
                            </h5>
                      ...
                      <div class="mil-team-card mil-up mil-mb-30">
                        ...
                        <div class="mil-description">
                          <div class="mil-secrc-text">
                            <h5 class="mil-muted mil-mb-5">
                              <a href="index.php">Oscar Freeman</a>
                            </h5>
                            <p class="mil-link mil-light-soft mil-mb-10">
                              Frontend Dev
                            </p>
                    ...
                    <div class="col-sm-6">
                      <p class="mil-mobile-hidden mil-text-sm mil-mb-30" style="height: 30px">
                        <span class="mil-accent">*</span> The founders of our
                        agency
                      </p>
                      ...
                      <div class="mil-team-card mil-up mil-mb-30">
                        ...
                        <div class="mil-description">
                          <div class="mil-secrc-text">
                            <h5 class="mil-muted mil-mb-5">
                              <a href="index.php">Emma Newman</a>
                            </h5>
                            <p class="mil-link mil-light-soft mil-mb-10">
                              Founder
                            </p>
                      ...
                      <div class="mil-team-card mil-up mil-mb-30">
                        ...
                        <div class="mil-description">
                          <div class="mil-secrc-text">
                            <h5 class="mil-muted mil-mb-5">
                              <a href="index.php">Lisa Trueman</a>
                            </h5>
                            <p class="mil-link mil-light-soft mil-mb-10">
                              UI/UX Designer
                            </p>
        ...
        <section class="mil-soft-bg">
          <div class="container mil-p-120-120">
            <div class="row">
              <div class="col-lg-10">
                <span class="mil-suptitle mil-suptitle-right mil-suptitle-dark mil-up">Customer reviews are a valuable source <br />of information
                  for both businesses and consumers.</span>
              </div>
            </div>

            <h2 class="mil-center mil-up mil-mb-60">
              Customer <span class="mil-thin">Voices:</span> <br />Hear What
                    ...
                    <div class="swiper-slide">
                      <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                        ...
                        <p class="mil-text-xl mil-up">
                          ...
                          in impressive and impactful work. I highly recommend
