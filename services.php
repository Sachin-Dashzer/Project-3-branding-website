...
<!-- Mirrored from miller.bslthemes.com/ashley-demo/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jul 2024 09:05:23 GMT -->
<head>
    ...
    <!-- Full Circle Solutions scss -->
    <link rel="stylesheet" href="css/style.css">
    <!-- page name -->
    <title>Full Circle Solutions</title>
    <link
            rel="icon"
            href="img/logo.png"
            type="image/x-icon"
...
<body>
    ...
    <div class="mil-wrapper" id="top">
            ...
            <div class="mil-preloader-animation">
                ...
                <div class="mil-pos-abs mil-animation-2">
                    <div class="mil-reveal-frame">
                        ...
                        <p class="mil-h3 mil-muted mil-thin">Full Circle Solutions</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mil-menu-frame">
            <!-- frame clone -->
            <div class="mil-frame-top mil-mb-60">
                <a href="home-1.html" class="mil-logo">
                    <img width="350px" src="img/logo2.png" alt="">
                </a>
                                ...
                                <div class="mil-menu-right">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-lg-8 mil-mb-60">
                                            ...
                                            <h6 class="mil-muted mil-mb-20">India</h6>

                                            <p class="mil-light-soft mil-up mil-mb-10"><span class="mil-mt-10 mil-mr-10"><svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#fff" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg> </span>CB 163, Naraina, New Delhi 110028 (INDIA)</p>
                                            <p class="mil-light-soft mil-up mil-mb-10"><span class="mil-mt-10 mil-mr-10"><svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#fff" d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/></svg></span> &nbsp; +91 9891914451 / 8920668900</p>
                                            <p class="mil-light-soft mil-up mil-mb-10"><span class="mil-mt-10 mil-mr-10"><svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#fff" d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg></span> &nbsp; rishi@fullcirclesolutions.in</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <a href="service.html" class="mil-service-card-lg mil-more mil-accent-cursor mil-offset">
                                                    <h4 class="mil-muted mil-up mil-mb-30">Packaging Design <br>& Production</h4>
                                                    <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our <strong>packaging design and production services</strong> are designed to create visually stunning and functional packaging that protects your products and captivates consumers. We utilize innovative design techniques and high-quality materials to deliver packaging solutions that enhance the overall customer experience. Whether you need custom boxes, eco-friendly packaging, or unique product displays, we have the expertise to make your packaging stand out on the shelves and drive sales.
                                                    </p>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="service.html" class="mil-service-card-lg mil-more mil-accent-cursor">
                                                    ...
                                                    <p class="mil-descr mil-light-soft mil-up mil-mb-30">At Full Circle Solutions, we help you build a strong <strong>brand identity</strong> that resonates with your target audience. Our comprehensive <strong>branding services</strong> include <strong>logo design</strong>, brand strategy development, and visual identity creation. We ensure that every element of your brand is cohesive and compelling, allowing you to create a lasting impression. From startups to established businesses, we tailor our branding strategies to meet your unique needs and elevate your market presence.
                                                    </p>
                                                    <!-- <ul class="mil-service-list mil-light mil-mb-30">
                                                        <li class="mil-up">UX Audits</li>
                                                        <li class="mil-up">Design thinking</li>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="service.html" class="mil-service-card-lg mil-more mil-accent-cursor mil-offset">
                                                    <h4 class="mil-muted mil-up mil-mb-30">Printing Solutions</h4>
                                                    <p class="mil-descr mil-light-soft mil-up mil-mb-30">Our <strong>printing solutions</strong> deliver high-quality, vibrant, and durable prints that enhance your marketing materials. We specialise in printing business cards, brochures, packaging, and more, ensuring that every piece reflects your brand's professionalism and quality. Utilizing the latest printing technology and techniques, we provide precise and consistent results that help you make a strong impact in the market. Trust our printing services to bring your designs to life with unmatched clarity and color accuracy.
                                                    </p>
                                                    <!-- <ul class="mil-service-list mil-light mil-mb-30">
                                                        <li class="mil-up">UX Audits</li>
                                                        <li class="mil-up">Design thinking</li>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="service.html" class="mil-service-card-lg mil-more mil-accent-cursor">
                                                    <h4 class="mil-muted mil-up mil-mb-30">Photography</h4>
                                                    <p class="mil-descr mil-light-soft mil-up mil-mb-30">Capture the essence of your brand with our <strong>professional photography services.</strong> High-quality images are crucial for effective branding and marketing, and our skilled photographers ensure that your products and promotional materials look their best. Whether it's product photography, corporate portraits, or lifestyle shoots, we create visually compelling images that enhance your brand's story and attract your target audience. Let our photography services elevate your brand's visual appeal and strengthen your marketing efforts.
                                                    </p>
                                                    <!-- <ul class="mil-service-list mil-light mil-mb-30">
                                                        <li class="mil-up">UX Audits</li>
                                                        <li class="mil-up">Design thinking</li>
                            ...
                            <div class="row justify-content-between flex-sm-row-reverse">
                                <div class="col-md-7 col-lg-6">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-8 col-lg-8 mil-mb-60">

                                            <h6 class="mil-muted mil-up mil-mb-20">India</h6>
